      ...
      - - **Filter & Search** – Filter expenses by date range, category, or amount
        - - **Responsive UI** – Clean, mobile-friendly interface with Bootstrap 5
          - - **SQLite Database** – Lightweight local database, no external server needed
            ...
            > *Dashboard showing expense breakdown by category*
            >
            > | Dashboard | Add Expense | Reports |
            > |-----------|-------------|---------|
            > | ![dashboard](https://via.placeholder.com/250x150?text=Dashboard) | ![add](https://via.placeholder.com/250x150?text=Add+Expense) | ![reports](https://via.placeholder.com/250x150?text=Reports) |
            >
            > ---
            >
            > ## 🛠️ Tech Stack
            ...
            > 2. 2. Enter amount, category (Food, Transport, etc.), date, and optional notes
            >    3. 3. Click **Save** — it appears instantly in your dashboard
            >      
            >       4. ### Setting a Budget
            >       5. 1. Go to **Settings → Budget**
            >          2. 2. Set a monthly limit for each category
            >             3. 3. You'll see a warning badge when you exceed 80% of the limit
            >               
            >                4. ### Exporting Data
            >                5. 1. Go to **Reports**
            >                   2. 2. Select a date range
            >                      3. 3. Click **Export CSV** to download your filtered expenses
            >                        
            >                         4. ---
            >                        
            ...
            >    3. 3. Make your changes and commit: `git commit -m "Add your feature"`
            >       4. 4. Push to your branch: `git push origin feature/your-feature-name`
